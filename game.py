...
ten_letters = ['jackrabbit', 'maximizers', 'abnormally', 'abolishers',
...
fifteen_letters = ['maneuverability', 'insubordination', 'excommunication',
...
def play_again():
    ...
    repeat = input("Would you like to play again " + player +
                   "? [Y/N]\n>").lower()
    if repeat == 'y':
        print("Let's play!")
        pick_difficulty()
